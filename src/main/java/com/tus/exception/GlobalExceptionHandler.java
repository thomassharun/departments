...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(DepartmentExistenceException.class)
	public ResponseEntity<ErrorDto> handleCustomerExistenceException(DepartmentExistenceException ce, WebRequest wr) {
